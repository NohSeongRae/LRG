    ...
    for i, G in enumerate(G_list):
        ...
        if is_single:
            ...
            nx.draw_networkx_nodes(
                G, pos, node_size=node_size, node_color="#336699", alpha=1, linewidths=0
            )
            nx.draw_networkx_edges(G, pos, alpha=alpha, width=width)
        else:
            nx.draw_networkx_nodes(
                G, pos, node_size=1.5, node_color="#336699", alpha=1, linewidths=0.2
            )
